...
A key result from Kolmogorov theory is that the structure function for the index of refraction follows a two-thirds power law.
...
The next step in this calculation is to use Equation \ref{eqn:kolmogorov}
